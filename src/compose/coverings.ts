...
export interface CoveringDefinition {
     ...
     * Keys are bone IDs or glob-style patterns (e.g., 'leg*', 'spine_*', '*').
     * Patterns are resolved by the system in order of specificity (exact match first, then longest pattern).
     */
    regions: {
