...
export const godRaysFragmentShader = /* glsl */ `
  ...
  void main() {
      ...
      vec2 deltaTexCoord = (vUv - lightScreenPos) * uDensity / float(uSamples);
...
export interface VolumetricSpotlightUniforms {
    ...
    uLightPosition: { value: number[] };
    uLightDirection: { value: number[] };
}
...
export function createGodRaysUniforms(
    ...
    return {
        ...
        uLightColor: { value: lightColor.toArray() },
        ...
        uResolution: { value: options.resolution?.toArray() ?? [1920, 1080] },
...
export function createVolumetricSpotlightUniforms(
    ...
    return {
        ...
        uLightPosition: { value: lightPosition.toArray() },
        uLightDirection: { value: lightDirection.toArray() },
    };
}
